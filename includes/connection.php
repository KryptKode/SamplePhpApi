<?php
    ...
    session_start();
 	...
 	header("Content-Type: text/html;charset=UTF-8");
		...
		if($_SERVER['HTTP_HOST']=="localhost" or $_SERVER['HTTP_HOST']=="192.168.43.199")
		{	
			//local  host
		...
		else
		{
			//local live  (online)
		 	 ...
		 	 DEFINE ('DB_USER', 'root'); //enter the user
			 DEFINE ('DB_PASSWORD', ''); //enter the database password
			 DEFINE ('DB_HOST', 'localhost'); //host name depends on server
			 DEFINE ('DB_NAME', 'wallpaper'); //enter the database name
		}
