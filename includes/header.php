  ...
  <aside class="app-sidebar" id="sidebar">
    ...
    <div class="sidebar-menu">
      <ul class="sidebar-nav">
        ...
        <li <?php if($currentFile=="manage_wallpaper_animation.php" or $currentFile=="add_wallpaper_animation.php" or $currentFile=="edit_wallpaper_animation.php"){?>class="active"<?php }?>> <a href="manage_wallpaper_animation.php">
